...
export async function updateLeavePolicySettingsAction(payload: {
  ...
  systemConfigStore.leavePolicy = {
    ...
    annualEligibleYears: Number(payload.annualEligibleYears) ?? 1,
    annualExpiryMonths: Number(payload.annualExpiryMonths) || 12,
    ...
    longLeaveExpiryMonths: Number(payload.longLeaveExpiryMonths) || 72,
    defaultInhaldagenDays: Number(payload.defaultInhaldagenDays) || 0,
    inhaldagenEligibleYears: Number(payload.inhaldagenEligibleYears) ?? 0,
    inhaldagenExpiryMonths: Number(payload.inhaldagenExpiryMonths) || 12,
