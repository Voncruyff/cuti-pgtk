...
export default function SettingsPage() {
  ...
  const loadSettings = async () => {
    ...
    if (res.success && res.data) {
      ...
      // Set Tab 1
      setDefaultAnnualDays(res.data.leavePolicy.defaultAnnualDays);
      setDefaultLongLeaveDays(res.data.leavePolicy.defaultLongLeaveDays);
      setActivePeriodYear(res.data.leavePolicy.activePeriodYear);
      setMaxAccumulatedDays(res.data.leavePolicy.maxAccumulatedDays);
      setLongLeaveIntervalYears(res.data.leavePolicy.longLeaveIntervalYears);
    ...
    <div className="space-y-6 w-full pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-slate-200/80 pb-3">
        <div>
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-extrabold uppercase tracking-wider text-[#0077b6] bg-sky-50 px-2.5 py-0.5 rounded-full border border-sky-200/80">
              • PUSAT PENGATURAN ADMINISTRATOR
            </span>
          </div>
        ...
        <Button
          ...
          className="rounded-full h-8.5 px-3 text-xs gap-1.5 self-start sm:self-center"
        >
              ...
              <Card className="border-slate-200/85 shadow-2xs">
                <CardHeader className="py-3.5 px-5 bg-gradient-to-r from-sky-50/50 via-slate-50/20 to-transparent border-b border-slate-100">
                  <CardTitle className="text-sm font-bold text-slate-900 flex items-center gap-2">
                    ...
                    Standar Kuota & Kebijakan Cuti Karyawan
                  </CardTitle>
                  <CardDescription className="text-xs">
                    Pengaturan nilai default hak kuota tahunan, cuti besar, dan batas akumulasi saldo cuti.
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="p-5 space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      <Label className="text-xs font-semibold text-slate-700">
                        Default Kuota Cuti Tahunan (Hari / Periode)
                      </Label>
                      <Input
                        type="number"
                        min={1}
                        ...
                        required
                      />
                      <p className="text-[11px] text-slate-400">Standar umum operasional PG Trangkil: 12 hari kerja.</p>
                    </div>

                    {/* Standar Cuti Besar */}
                    <div className="space-y-1.5">
                      <Label className="text-xs font-semibold text-slate-700">
                        Default Kuota Cuti Besar (Hari)
                      </Label>
                      <Input
                        type="number"
                        min={1}
                        ...
                        required
                      />
                      <p className="text-[11px] text-slate-400">Diberikan setiap kelipatan masa dinas 6 tahunan.</p>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className="h-9 text-xs rounded-full font-mono font-bold text-slate-900"
                        required
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className="h-9 text-xs rounded-full font-mono font-bold text-emerald-700"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-end pt-3 border-t border-slate-100">
                    <Button
                      type="submit"
                      disabled={isPending}
                      className="rounded-full gap-2 px-6 h-9 text-xs font-bold bg-[#0084c7] hover:bg-[#0077b6] text-white shadow-xs"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className="h-9 text-xs rounded-full font-bold"
                        required
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className="h-9 text-xs rounded-full font-bold text-[#0084c7]"
                        required
                      />
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="h-9 text-xs rounded-full font-medium"
                          required
                        />
                      </div>
